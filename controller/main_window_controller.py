...
class MainWindowController:
    ...
    def showAddProjectDialog(self):
        ...
        def onSaveBtnClicked():
            ...
            # 添加到listwidget中
            self.ui.listWidget.addItem(project.name)
    ...
    def project2ProjectWidget(self, project: Project):
        ...
        widget.ui.pushButton_5.setText(project.name if project.name !="" else "input name")

        def onProjecNameBtnClicked():
            projectName, isOk = QInputDialog.getText(widget, "input project name", "project name")
            if isOk:
                widget.ui.pushButton_5.setText(projectName)
