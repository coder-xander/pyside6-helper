...
if __name__ == '__main__':
    ...
    # print(find_file_by_filename("pyside6-uic.exe"))

    #设置配置文件
    app_config.setData(  {
            "path_info": {
                "qt_ui_file_path": r"C:\Users\oct-x\Desktop\pyside6-assistant\qt_ui_files",
                "qt_py_ui_path": r"C:\Users\oct-x\Desktop\pyside6-assistant\qt_py_ui_files",
